  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.viewrow}>
        <Image style={{ width: 28, height: 30 }} source={require('../assets/star.png')}></Image>
        <Image style={{ width: 28, height: 30 }} source={require('../assets/star.png')}></Image>
        <Image style={{ width: 28, height: 30 }} source={require('../assets/star.png')}></Image>
        <Image style={{ width: 28, height: 30 }} source={require('../assets/star.png')}></Image>
        <Image style={{ width: 28, height: 30 }} source={require('../assets/star.png')}></Image>
        ...
        <Image style={{ width: 25, height: 25, margin: 10, marginTop: 25 }} source={require('../assets/Group 1.png')}></Image>
